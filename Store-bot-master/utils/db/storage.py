...
class DatabaseManager(object):
    ...
    def create_tables(self):
        ...
        self.query('CREATE TABLE IF NOT EXISTS orders (cid int, usr_name text, usr_address text, usr_phone int, usr_locathin STRING, products text)')
...
orders: cid int, usr_name text, usr_address text, usr_phone int, usr_locathin STRING, products text
